...
module.exports = {
  ...
  body: p => {
    ...
    const front = `
        ...
        (fp_line (start 7 17.5) (end 7 -17.5) (layer F.Fab) (width 0.15))
        (fp_line (start -6.41 ${p.reverse ? 14.1 : 15.37}) (end -6.41 18.03) (layer F.SilkS) (width 0.12))
        ...
        (fp_line (start 6.41 ${p.reverse ? 14.1 : 15.37}) (end 6.41 18.03) (layer F.SilkS) (width 0.12))
        (fp_line (start 6.41 ${p.reverse ? 14.1 : 15.37}) (end -6.41 ${p.reverse ? 14.1 : 15.37}) (layer F.SilkS) (width 0.12))

        (fp_arc (start -7 17.5) (mid -6.8536 17.8536) (end -6.5 18) (layer F.Fab) (width 0.15))
        (fp_arc (start 6.5 -18) (mid 6.8536 -17.8536) (end 7 -17.5) (layer F.Fab) (width 0.15))
        (fp_arc (start 7 17.5) (mid 6.8536 17.8536) (end 6.5 18) (layer F.Fab) (width 0.15))
        (fp_arc (start -6.5 18) (mid -6.8536 17.8536) (end -7 17.5) (layer F.Fab) (width 0.15))
    ...
    const back = `
        (fp_line (start 6.41 ${p.reverse ? 14.1 : 15.37}) (end 6.41 18.03) (layer B.SilkS) (width 0.12))
        (fp_line (start 6.41 ${p.reverse ? 14.1 : 15.37}) (end -6.41 ${p.reverse ? 14.1 : 15.37}) (layer B.SilkS) (width 0.12))
        ...
        (fp_line (start 6.5 -18) (end -6.5 -18) (layer B.Fab) (width 0.15))
        (fp_line (start -7 -17.5) (end -7 17.5) (layer B.Fab) (width 0.15))
        (fp_arc (start -7 17.5) (mid -6.8536 17.8536) (end -6.5 18) (layer B.Fab) (width 0.15))
        (fp_arc (start 6.5 -18) (mid 6.8536 -17.8536) (end 7 -17.5) (layer B.Fab) (width 0.15))
        (fp_arc (start 7 17.5) (mid 6.8536 17.8536) (end 6.5 18) (layer B.Fab) (width 0.15))
        (fp_arc (start -6.5 18) (mid -6.8536 17.8536) (end -7 17.5) (layer B.Fab) (width 0.15))
    `
