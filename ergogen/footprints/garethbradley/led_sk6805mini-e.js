...
//
// Description:
//  Reversible footprint for "YS-SK6803mini-e" LEDs, to be used either as per-key lightning or
...
//
// Datasheet:
//  http://www.normandled.com/Product/view/id/875.html
//
// Nets:
...
module.exports = {
  ...
  (footprint "garethbradley:led_SK6805mini-e (${p.reverse_mount ? "per-key" : "underglow"}${p.reversible ? ", reversible" : "single-side"})" 
    (layer "${p.side}.Cu")
    ${p.at}
