...
//  https://grabcad.com/library/jst-ph-2-0mm-connector-pack-through-hole-smt-ds1066-1/details?folder_id=9550291
...
module.exports = {
  params: {
    ...
    socket_3dmodel_filename: '${EG_GARETHBRADLEY_3D_MODELS}/JST-S2B-PH-K-S.STEP',
    socket_3dmodel_side: '',
  ...
  body: p => {
    ...
    (footprint "garethbradley:battery_connector_jst_ph_2"
        (layer "${p.side}.Cu")
        ${p.at}
